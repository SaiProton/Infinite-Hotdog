...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    for(int i = 0; i < 2; i++) {
      leftMotors[i] = new CANSparkMax(Constants.LEFT_MOTOR_CANS[i], MotorType.kBrushless);
      rightMotors[i] = new CANSparkMax(Constants.RIGHT_MOTOR_CANS[i], MotorType.kBrushless);
